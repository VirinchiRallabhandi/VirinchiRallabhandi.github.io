...
excerpt: "I prove positive energy theorems and BPS inequalities on a class of asymptotically, locally AdS spacetimes. The link below goes to a PDF of the published version, while the link above also contains the arXiv version, some additional information and some extended notes."
date: 2025-08-27
paperurl: 'https://iopscience.iop.org/article/10.1088/1361-6382/ae2e78/pdf'
---
...
The published version is available [here](https://iopscience.iop.org/article/10.1088/1361-6382/ae2e78/pdf), the arXiv PDF is available [here](https://arxiv.org/pdf/2508.19108) and some more extended notes are available [here](https://virinchirallabhandi.github.io/pdfs/adsPositiveEnergyNotes.pdf).
